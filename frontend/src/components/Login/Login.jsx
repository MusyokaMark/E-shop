...
import { AiOutlineEye, AiOutlineEyeInvisible, AiFillFacebook, AiFillGoogleCircle } from "react-icons/ai";
        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          ...
          <form className="py-4">
            <div>
              ...
              >
                <div className="flex items-center"> {/* Wrap icon and text in a flex container */}
                  <AiFillFacebook className="mr-2" size={25} /> {/* Adjust margin as needed */}
